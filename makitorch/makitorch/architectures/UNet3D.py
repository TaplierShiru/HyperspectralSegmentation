...
class UNet3D(Module):
    ...
    def __init__(self, in_ch=1, out_ch=1, feat_channels=[64, 256, 256, 512, 1024], residual='conv'):
        ...
        self.conv_blk1 = Conv3D_Block(in_ch, feat_channels[0], residual=residual)
        ...
        self.one_conv = Conv3d(feat_channels[0], out_ch, kernel_size=1, stride=1, padding=0, bias=True)
