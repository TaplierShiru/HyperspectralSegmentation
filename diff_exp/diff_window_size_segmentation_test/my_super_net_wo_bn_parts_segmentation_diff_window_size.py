...
#    { "cut_window": (64, 64),   "batch_size": 128,   "lr": 1e-3, "max_epochs": 10  },  # Max: 128
    { "cut_window": (128, 128), "batch_size": 128,   "lr": 1e-3, "max_epochs": 150  },  # Max: 128
    { "cut_window": (256, 256), "batch_size": 86,    "lr": 8e-4, "max_epochs": 200  },  # Max: 64
    { "cut_window": (512, 512), "batch_size": 22,    "lr": 3e-4, "max_epochs": 300  },  # Max: 22
]
