...
CUT_WINDOW_SIZE_LIST = [
    { "cut_window": (1, 1),     "batch_size": 32768, "lr": 5e-2 },  # Max: 32768
    { "cut_window": (2, 2),     "batch_size": 4096,  "lr": 2e-2 },  # Max: 4096
    { "cut_window": (4, 4),     "batch_size": 512,   "lr": 4e-3 },  # Max: 512
    { "cut_window": (8, 8),     "batch_size": 128,   "lr": 1e-3 },  # Max: 128
    { "cut_window": (16, 16),   "batch_size": 128,   "lr": 1e-3 },  # Max: 128
    { "cut_window": (32, 32),   "batch_size": 128,   "lr": 1e-3 },  # Max: 128
    { "cut_window": (64, 64),   "batch_size": 128,   "lr": 1e-3 },  # Max: 128
    { "cut_window": (128, 128), "batch_size": 128,   "lr": 1e-3 },  # Max: 128
    { "cut_window": (256, 256), "batch_size": 86,    "lr": 2e-3 },  # Max: 64
    { "cut_window": (512, 512), "batch_size": 22,    "lr": 6e-3 },  # Max: 22
]
...
def start_exp(
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=5, pin_memory=False, prefetch_factor=2
    )
    ...
    name_exp = f"MySuperNetLittleInput Segmentation cut_window={cut_window} (run {number_of_exp})"+\
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"pytorch_li_logs/(run={number_of_exp})MySuperNetLittleInput Segmentation  cut_window={cut_window} "+\
