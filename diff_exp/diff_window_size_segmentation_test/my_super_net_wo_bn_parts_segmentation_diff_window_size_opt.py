...
#    { "cut_window": (64, 64),   "batch_size": 128,   "lr": 1e-3, "max_epochs": 10  },  # Max: 128
    { "cut_window": (128, 128), "batch_size": 128,   "lr": 1e-3, "max_epochs": 250  },  # Max: 128
    { "cut_window": (256, 256), "batch_size": 86,    "lr": 8e-4, "max_epochs": 300  },  # Max: 64
    { "cut_window": (512, 512), "batch_size": 22,    "lr": 4e-4, "max_epochs": 400  },  # Max: 22
]
...
def start_exp(
    ...
    name_exp = f"MySuperNetLittleInput Segmentation cut_window={cut_window} (run {number_of_exp}) rerun=2"+\
               f" | LrCosine W weight decay | lower arch | {max_epochs}ep | Wo full PCA." +\
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"pytorch_li_logs/(run={number_of_exp})MySuperNetLittleInput Segmentation  cut_window={cut_window}  rerun=2"+\
