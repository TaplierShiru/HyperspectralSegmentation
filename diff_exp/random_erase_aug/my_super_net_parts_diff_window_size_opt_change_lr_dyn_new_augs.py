...
#    { "cut_window": (64, 64),   "batch_size": 128,   "lr": 1e-3, "max_epochs": 10  },  # Max: 128
    ...
    { 
        "cut_window": (256, 256), "batch_size": 86, "lr": 5e-4, 
...
def start_exp(
    ...
    name_exp = f"TEST-NEW-METRIC-CALC // Erase test cut_window={cut_window} (run {number_of_exp})" +\
    ...
    comet_exp.add_tag('TEST-NEW-METRIC-CALC_random_erase_test')
