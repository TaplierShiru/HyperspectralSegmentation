...
#    { "cut_window": (64, 64),   "batch_size": 128,   "lr": 1e-3, "max_epochs": 10  },  # Max: 128
    { 
        "cut_window": (128, 128), "batch_size": 2, "lr": 1e-3, 
...
def start_exp(
    ...
    name_exp = f"Attention moduleV3 test cut_window={cut_window} (run {number_of_exp})" +\
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"pytorch_li_logs/rerun=3(v3)/(run={number_of_exp})Attention_module_test_"+\
