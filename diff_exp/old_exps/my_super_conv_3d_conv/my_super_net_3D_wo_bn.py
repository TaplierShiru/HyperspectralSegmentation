...
class MySuperNet3D(nn.Module):
    ...
    def __init__(self, in_f=17, out_f=17, *args):
        ...
        self.conv1 = nn.Conv3d(1, 16, kernel_size=(5, 5, 3), stride=1, padding=(2, 2, 1))
        self.bn1 = nn.BatchNorm3d(16)
        self.act1 = nn.ReLU()
        
        self.conv2 = nn.Conv3d(16, 32, kernel_size=(5, 5, 3), stride=1, padding=(2, 2, 1))
        self.bn2 = nn.BatchNorm3d(32)
        self.act2 = nn.ReLU()
        
        self.conv3 = nn.Conv3d(32, 16, kernel_size=(5, 5, 3), stride=1, padding=(2, 2, 1))
        self.bn3 = nn.BatchNorm3d(16)
        self.act3 = nn.ReLU()
        
        self.conv4 = nn.Conv3d(16, 1, kernel_size=(5, 5, 3), stride=1, padding=(2, 2, 1))
...
ARCH_TYPES = [
    (MySuperNet3D.__name__,                                       {"batch_size": 8}),
]
...
def start_exp(number_of_exp: int, T_0: int, T_mult: int, arch_type: str, batch_size: int, gamma: float):
    ...
    name_exp = f"MySuperNet3D WithOut BN (run {number_of_exp}) | LrCosine W weight decay | lower arch | 70ep | W full PCA." +\
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"pytorch_li_logs/(run={number_of_exp})MySuperNet3D WithOut BN | _LrCosine W weight decay lower_" +\
