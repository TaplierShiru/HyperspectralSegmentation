...
#    (MySuperFatsWStrideTwoNet.__name__,                         {"batch_size": 16}), # part2
    (MySuperFatsWStrideTwoKernel3Net.__name__,                  {"batch_size": 22}), # part3
    (MySuperFatsWStrideTwoAndSkipConnectionNet.__name__,        {"batch_size": 22}), # part3
    (MySuperFatsWStrideTwoAndSkipConnectionKernel3Net.__name__, {"batch_size": 22}), # part3
