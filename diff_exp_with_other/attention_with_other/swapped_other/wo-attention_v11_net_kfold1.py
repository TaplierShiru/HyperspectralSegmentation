...
PATH_DATA = f'/raid/rustam/hyperspectral_dataset/diff_exp_with_other__attention_with_other/swapped/{KFOLD}'
...
def start_exp(
    ...
    name_exp = f"SW-AttentionV11-WO({KFOLD}) with other (run={number_of_exp})"
    comet_exp.set_name(name_exp)
    comet_exp.add_tag('attention_wo_swapped_module_with_other')
